...
# runbooks (no agent frontmatter), not agents. docs/ holds repo documentation
# (schemas, templates). None is a division — they must never be scanned as
# source-agent categories.
NON_DIVISION_DIRS=(examples scripts integrations strategy docs)
